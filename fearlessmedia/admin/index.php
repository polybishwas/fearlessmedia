...
<head>
  ...
  <title>fearlessmedia | Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="../assets/images/fearlessmedia_logo.png" alt="AdminLTELogo" height="500" width="500">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="../assets/images/fearlessmedia_logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .9">
      <span class="brand-text font-weight-normal">𝓕𝓮𝓪𝓻𝓵𝓮𝓼𝓼𝓜𝓮𝓭𝓲𝓪</span>
    </a>
...
?>
  ...
  <footer class="main-footer">
    <strong>😊This presentation is for educational purposes only. Created by <a href="https://www.facebook.com/poly.bishwas.7" target="_blank">Poly Bishwas</a> & <a href="https://www.facebook.com/moon.jili" target="_blank">Aditi Dhar</a>
