 ...
 <div class="card-body">
    ...
    <?php
                ...
                <div class="input-group p-2 <?=$post['post_text']?'border-top':''?>">
                        ...
                        <input type="text" class="form-control rounded-0 border-0 comment-input" placeholder="Add a comment..."
...
<div class="d-flex align-items-center p-2">
    ...
    <?php
                        ...
                        <div class="input-group p-2 border-top">
                            <input type="text" class="form-control rounded-0 border-0 comment-input" placeholder="Add a comment..."
                                aria-label="Recipient's username" aria-describedby="button-addon2">
                            <button class="btn btn-outline-success rounded-0 border-0 add-comment" data-cs="comment-section<?=$post['id']?>" data-post-id="<?=$post['id']?>" type="button"
                                id="button-addon2">Comment</button>
                        </div>
                    </div>
...
<div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        <button class="btn btn-sm btn-success followbtn" data-user-id='<?=$suser['id']?>' >Follow</button>
